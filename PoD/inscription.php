...
<form name="inscription" id="inscription" method="POST" action="inscription.php">

    <fieldset>

        <label>Mail</label><input name="mail" type="email" >
        <label>Pseudo</label><input name="Pseudo" type="text" >
        <label>Passe</label><input name="Passe" type="password">
