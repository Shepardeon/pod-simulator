...
(
    ...
    Pass    VARCHAR       NOT NULL    COMMENT 'Le mot de passe du joueur',
    Mail 		CHAR(50) 		NOT NULL		COMMENT 'Permet d\'éditer le profil unique et permet la reconnexion',
    Valide 		BOOLEAN 		NOT NULL		COMMENT 'Permet de savoir si l\'utilisateur à validé son compte',
    Chaine_Validation 	CHAR(10) 		NOT NULL		COMMENT 'Coorespond à la chaine envoyé par mail pour finaliser la création du compte',
    Fonds 		SMALLINT 		NOT NULL		COMMENT 'Ressources du joueur issue de ses différentes attaques, peut être dilapidée par des joueurs adverses',
    Fonds_Securise 	SMALLINT 		NOT NULL		COMMENT 'Ressources du joueur inviolable par un adversaire, dépend du niveau du joueur',
    Revenus 		SMALLINT 		NOT NULL		COMMENT 'Gain régulier du joueur',
    Niveau		SMALLINT 		NOT NULL		COMMENT 'Niveau du joueur, évolue suivant les attaques du joueur',
...
(
    ...
    Pare_feu			INTEGER 		NOT NULL	COMMENT 'Niveau du pare-feu du joueur',
    Anti_Virus			INTEGER 		NOT NULL	COMMENT 'Niveau de l\'anti-virus du joueur',
    Porte_Feuille		INTEGER 		NOT NULL	COMMENT 'Niveau qui permet d\'obtenir plus de revenus',
    Scanner_Reseau		INTEGER 		NOT NULL	COMMENT 'Fonction du jeu',
    FW_Cracker			INTEGER 		NOT NULL	COMMENT 'Fonction du jeu',
    SW_Cracker 			INTEGER 		NOT NULL	COMMENT 'Fonction du jeu',
    Generateur_de_Miner		INTEGER 		NOT NULL	COMMENT 'Fonction du jeu',
    Generateur_de_Backdoor	INTEGER 		NOT NULL	COMMENT 'Fonction du jeu',
    Carte_Reseau		INTEGER 		NOT NULL	COMMENT 'Niveau de la carte réseau de la machine du joueur',
    Processeur			INTEGER 		NOT NULL	COMMENT 'Niveau du processeur de la machine du joueur',
    Disque_Dur			INTEGER			NOT NULL	COMMENT 'Niveau de disque dur de la machine du joueur',
...
(
    ...
    Niveau 			SMALLINT 		NOT NULL	COMMENT 'Défini les différents types de virus du plus gentil au plus agressif',
