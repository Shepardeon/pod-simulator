...
(
    ...
    Fonds 		                INT 		                NOT NULL	DEFAULT 1000           COMMENT 'Ressources du joueur issue de ses différentes attaques, peut être dilapidée par des joueurs adverses',
    Fonds_Securise 	            INT 		                NOT NULL	DEFAULT 0           COMMENT 'Ressources du joueur inviolable par un adversaire, dépend du niveau du joueur',
    Revenus 		            INT 		                NOT NULL	DEFAULT 0	    COMMENT 'Gain régulier du joueur',
    Niveau		                INT		                NOT NULL	DEFAULT 1           COMMENT 'Niveau du joueur, évolue suivant les attaques du joueur',
